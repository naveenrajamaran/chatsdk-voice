...
//                if (thread.getType()==BThread.Type.Private)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ChatSDKChatHelper.ADD_USERS)
        {
        ...
        else if (requestCode == ChatSDKChatHelper.SHOW_DETAILS)
        {
    ...
    protected void startAddUsersActivity(){
        ...
        startActivityForResult(intent, ChatSDKChatHelper.ADD_USERS);
    ...
    protected void openThreadDetailsActivity(){
        ...
        startActivityForResult(intent, ChatSDKChatHelper.SHOW_DETAILS);
    ...
    public ChatSDKChatHelper getChatSDKChatHelper() {
        return chatSDKChatHelper;
    }
}
