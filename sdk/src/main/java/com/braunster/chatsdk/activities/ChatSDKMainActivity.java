...
//                if (DEBUG) Log.v(TAG, "onPageScrollStateChanged");
    ...
    private void firstTimeInApp(){
        if (PreferenceManager.getDefaultSharedPreferences(this).getBoolean(FIRST_TIME_IN_APP, true))
        {
            ...
            Utils.FileSaver.getAlbumStorageDir(this, BDefines.ImageDirName, Utils.FileSaver.IMG_DIR_ID);
            // Creating the audio directory if not exist.
            Utils.FileSaver.getAlbumStorageDir(this, BDefines.AudioDirName, Utils.FileSaver.AUDIO_DIR_ID);
            // Creating the video directory if not exist.
            Utils.FileSaver.getAlbumStorageDir(this, BDefines.VideoDirName, Utils.FileSaver.VIDEO_DIR_ID);
