...
public class BDefines {
    ...
    /**
     * The name of the app audio directory that will be seen in the phone audio galley
     * */
    public static final String AudioDirName = "AndroidChatSDK";

    /**
     * The name of the app video directory that will be seen in the phone video galley
     * */
    public static final String VideoDirName = "AndroidChatSDK";
    ...
    public static final class Options{
        ...
        /**
         * if true option to send audio will be available this also affect recording audio using the camera.
         **/
        public static boolean AudioEnabled = true;

        /**
         * if true option to send video will be available this also affect recording video using the camera.
         **/
        ...
        /**
         * if true audio and video files are shown as textual links and not as widgets.
         **/
        public static boolean ShowFileAsLink = false;
        ...
        public static boolean SaveAudioToDir = false;

        public static boolean SaveVideoToDir = false;

        /**
         * The formats used for images, audio and video
         **/
        public static String ImagesFormat = ".jpeg";

        public static String AudioFormat = ".3gp";

        public static String VideoFormat = ".mp4";

        /**
         * The minimum length for an audio message in ms
         **/

        public static int minAudioLength = 2000;
