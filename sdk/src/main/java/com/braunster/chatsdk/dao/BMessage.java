...
public class BMessage extends BMessageEntity  {
    ...
    public BMessage(Long id, String entityID, java.util.Date date, Boolean isRead, String resources, String resourcesPath, String text, String imageDimensions, Integer type, Integer status, Integer delivered, Integer duration, Long Sender, Long threadDaoId) {
        this.id = id;
