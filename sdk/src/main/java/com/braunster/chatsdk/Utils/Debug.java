...
public class Debug {
    ...
    public static final boolean ViewVideoActivity = true;
    ...
    /*Views*/
    public static final boolean ChatBubbleImageView = true;
    public static final boolean ChatBubbleAudioView = true;
    public static final boolean ChatBubbleVideoView = true;
    public static final boolean ChatMessageBoxView = true;
