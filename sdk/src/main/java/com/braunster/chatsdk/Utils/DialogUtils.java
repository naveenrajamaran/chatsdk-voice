...
public class DialogUtils {
    ...
    public static PopupWindow getMenuOptionPopup(Context context, View.OnClickListener listener){
        ...
        popupView.findViewById(R.id.chat_sdk_btn_choose_audio).setOnClickListener(listener);
        popupView.findViewById(R.id.chat_sdk_btn_record_audio).setOnClickListener(listener);
        popupView.findViewById(R.id.chat_sdk_btn_choose_video).setOnClickListener(listener);
        popupView.findViewById(R.id.chat_sdk_btn_record_video).setOnClickListener(listener);
        ...
        {
            popupView.findViewById(R.id.chat_sdk_btn_choose_audio).setVisibility(View.GONE);
            popupView.findViewById(R.id.chat_sdk_btn_record_audio).setVisibility(View.GONE);
        }

        if (!BDefines.Options.VideoEnabled)
        {
            popupView.findViewById(R.id.chat_sdk_btn_choose_video).setVisibility(View.GONE);
            popupView.findViewById(R.id.chat_sdk_btn_record_video).setVisibility(View.GONE);
        }
                    ...
                    VolleyUtils.getImageLoader().get(data, new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(final ImageLoader.ImageContainer response, boolean isImmediate) {
                            ...
                            if (response.getBitmap() != null)
                            {
                                ...
                                if (saveToDir)
                                {
                                    File file, dir = Utils.FileSaver.getAlbumStorageDir(context, Utils.FileSaver.IMG_DIR_NAME, Utils.FileSaver.IMG_DIR_ID);
                                    if (dir != null)
                                        if(dir.exists()) {
