...
public class ChatSDKProfileHelper {
    ...
    public  Promise<String[], BError, SaveFileProgress> saveProfilePicToServer(String path, boolean setAsPic) {
    ...
    /** Only for current user.*/
    public Promise<String[], BError, SaveFileProgress> saveProfilePicToServer(String path){
        ...
        return BNetworkManager.sharedManager().getNetworkAdapter().uploadImage(
                ...
                .fail(new FailCallback<BError>() {
                    ...
                    public void onFail(BError error) {
                        if (DEBUG)
                            Timber.e("Firebase Exception while saving profile pic, message: %s", error.message);
                    }
                });
    }
