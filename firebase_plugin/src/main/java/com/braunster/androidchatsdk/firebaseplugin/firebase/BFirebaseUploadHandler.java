...
public class BFirebaseUploadHandler implements BUploadHandler {
    ...
    @Override
    public Promise<String, BError, SaveFileProgress> uploadFile(byte[] data, String name, String mimeType) {
        final Deferred<String, BError, SaveFileProgress> deferred = new DeferredObject<>();
        ...
        uploadTask.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
            ...
            public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                deferred.notify(new SaveFileProgress());
            }
